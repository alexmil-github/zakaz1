                    ...
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('order.store') }}" enctype="multipart/form-data" id="addOrder">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="adress" type="text" class="form-control @error('adress') is-invalid @enderror" name="adress" value="{{ $order->adress }}" required autocomplete="adress" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $order->description }}" required autocomplete="description">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="max_price" type="number" class="form-control @error('max_price') is-invalid @enderror" name="max_price" value="{{ $order->max_price }}">
